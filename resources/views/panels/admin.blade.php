...
<div style="display:flex;justify-content:space-between;align-items:center;gap:18px"><div><span class="eyebrow" style="color:#057d78;background:#e8fffd">ADMIN CONTROL</span><h1>KYP Administration</h1><p style="color:var(--muted)">Learning, assessment और certification का live central overview।</p></div><form method="POST" action="{{ route('logout') }}">@csrf<button class="btn btn-light">Logout</button></form></div>
